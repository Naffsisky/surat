        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-3">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-file"></i> Lampiran</a>
              </li>
              <li class="nav-item">
        ...
        <table class="table">
          <thead class="table-dark">
            ...
            <tr>
              ...
              <td><a href="download.php?id=<?= $row["id"] ?>" class="btn btn-primary">Download</a></td>
